...
│       └── service_tests.rs   # Unit tests (172, incl. process-tree integration)
...
│           └── kits_tests.rs  # Unit + integration tests (32 + 2 ignored)
...
├── .github/                   # GitHub community templates (issues / PR) + CI workflow (fmt/clippy/test)
...
```powershell
# Rust (172 tests + 32 plugin tests + 2 ignored, incl. a real process-tree integration test)
